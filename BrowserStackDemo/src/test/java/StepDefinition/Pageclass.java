...
public class Pageclass {
	...
	public void AddressInfo() {
		wait.until(ExpectedConditions.visibilityOfElementLocated(firstName)).sendKeys("jampana");
		wait.until(ExpectedConditions.visibilityOfElementLocated(lastName)).sendKeys("AswiniKumar");
		wait.until(ExpectedConditions.visibilityOfElementLocated(address))
				.sendKeys("9-124,market street,vijayawada");
		wait.until(ExpectedConditions.visibilityOfElementLocated(province)).sendKeys("AndhraPradesh");
		wait.until(ExpectedConditions.visibilityOfElementLocated(postCode)).sendKeys("521165");
	}
	...
	public void NewsletterEmail() {
		wait.until(ExpectedConditions.visibilityOfElementLocated(newsletterEmail)).sendKeys("xyz@gmail.com");
	}
